  ...
  return (
    <Card title="系统管理台" style={{borderRadius: token.borderRadius}}>
      ...
      <Tabs items={[
        {
          key: '1',
          label: <span><UserOutlined/> 账号管理</span>,
          children: <Table dataSource={users} columns={userColumns} rowKey="user_id"/>
        },
        {
          key: '2',
          label: <span><TeamOutlined/> 团队概览</span>,
          children: <Table dataSource={teams} columns={teamColumns} rowKey="team_id"/>
        }
      ]}/>
